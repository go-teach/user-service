...
RSpec.describe 'Students API', type: :request do
  ...
  describe 'POST /students' do
    # valid payload
    let(:valid_attributes) { { full_name: 'Learn Elm', phone_number: '1' } }
    ...
    context 'when the request is invalid' do
      before { post '/students', params: { full_namea: 'Foobar' } }
      ...
      it 'returns a validation failure message' do
        expect(response.body)
          .to match(/Validation failed: Full name can't be blank/)
      end
    end
  end
